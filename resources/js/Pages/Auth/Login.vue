            ...
            <b-container>
                ...
                <b-col md="8" lg="6" xl="5">
                    ...
                    <b-card-body class="p-4">
                            <div class="row mb-n3">
                                <div class="col-2">
                                    <img src="images/logo.png" alt="" class="avatar-sm">
                                </div>
                                <div class="col-10">
                                    <div class="text-primary mt-1">
                                        <h4>General Merchandise </h4>
                                        <p class="mt-n2">Web and Android-based POS System</p>
                                    </div>
                                </div>
                            </div>
                            <div class="p-2 mt-4">
                        ...
                        <form class="customform" @submit.prevent="submit">
                            ...
                            <div class="mt-4">
                                ...
                                <b-button :class="{ 'opacity-25': form.processing }" :disabled="form.processing" variant="dark" class="w-100" type="submit">
                                    Sign In
                                </b-button>
                            </div>
